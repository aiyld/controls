...
export default class BoxView extends Component{
    ...
    onScrollHandler(){
        ...
        const inViewportTop = Boolean(top + height - BVHeadHeight>= HEADERHEIGHT && top < HEADERHEIGHT);
    ...
    render(){
        ...
        return <div ref={container=>this.container=container} className={"box-view "+position}>
            <div ref="header" className="bv-header " onClick={this.show.bind(this, null)}>
                <h3 className="flex tl">客队</h3>
                <h3 className="title">
                    {title}
                    <span className="toggle"><span className="arrows"></span></span>
                </h3>
                <h3 className="flex tr">客队</h3>
            </div>
